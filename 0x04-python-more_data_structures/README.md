...
* **0. Squared simple**
  ...
  * The parameter  is a two-dimensional array.
  * Returns a matrix of the same size as  where each value is the
...
* **1. Search and replace**
  ...
  * The parameter  is the initial list.
  * The parameter  is the element to replace in the list.
  * The parameter  is the new element.
  * Without importing modules.
...
* **8. Simple delete by key**
  * [8-simple_delete.py](./8-simple_delete.py): Python function that deletes a key
  in a dictionary.
  * The paramter  is always a string.
...
* **11. Multiply by using map**
  ...
  * Returns a new length of the same length has  with each value
  multiplied by .
...
* **12. Roman to Integer**
  ...
  * If the parameter  is not a string or , the function returns .

* **13. Weighted average103-python.c*
...
* **14. Squared by using map**
  ...
  * The parameter  is a two-dimensional array.
  * Returns a new matrix of the same size as  with each value squared.
  * The initial matrix is not modified.
  * Without using loops or importing modules.
